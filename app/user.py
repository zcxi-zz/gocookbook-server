...
class User(UserMixin, db.Model):
    ...
    ingredients = db.relationship('UI_Association')
    prefers_metric_volume = db.Column(db.Boolean)
    prefers_metric_mass = db.Column(db.Boolean)
...
def get_username(user_id):
    return User.query.get(int(user_id)).username
